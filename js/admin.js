...
function afterThePageLoads() {
    ...
    /* check for changes to table every 3 seconds */
    ...
    function afterTableLoads() {
        ...
        $('.delete-button').click(function () {
            ...
            $.ajax({
                url: "./api.php",
                type: "POST",
                data: {'restaurant_id': restaurant_id, 'cmd': 'deleteRestaurant'},
                success: function () {
        ...
        * and close orders buttons */
        ...
        $(".take-orders-button").click(function() {
            ...
            $.ajax({
                url: "./api.php",
                type: 'POST',
                data: {'cmd': "takeOrders", 'restaurant_id': restaurant_id}
            });
        });
        ...
        $(".close-orders-button").click(function() {
            ...
            $.ajax({
                url: "./api.php",
                type: 'POST',
                data: {'cmd': "closeOrders", 'restaurant_id': restaurant_id},
                success: function() {
                    refreshTakenOrders();
                }
            })
